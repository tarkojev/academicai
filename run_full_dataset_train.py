...
- A custom T5 encoder-based classifier for the AG News task.
- A training loop that trains the model on the full training set.
- A prediction function that runs inference on the test set and computes metrics.
- Efficiency benchmarking that measures parameter count, model size, and inference latency.
